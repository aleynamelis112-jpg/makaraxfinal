      ...
      <div className="max-w-7xl mx-auto px-6 text-center z-10">
        <div className="animate-fade-in flex flex-col items-center">
          ...
          <div className="mb-12">
            ...
            <p className="mt-4 text-sm md:text-base font-semibold text-white/80 tracking-[0.25em] uppercase">
              WELIS ROOT WOOD MARKASIDIR
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center w-full max-w-4xl mx-auto">
            ...
            <Link href="#products" className="flex-1">
              <Button
                size="lg"
                className="w-full bg-white text-black hover:bg-white/90 rounded-2xl py-8 text-lg font-bold btn-premium"
              >
                Ürünleri İncele
              </Button>
            </Link>
            ...
            <Link href={instagramUrl} target="_blank" className="flex-1">
              <Button
                size="lg"
                className="w-full bg-gradient-to-tr from-orange-500 via-pink-600 to-purple-600 text-white hover:opacity-90 rounded-2xl py-8 text-lg font-bold shadow-xl border-none"
              >
            ...
            <Link href={getWhatsAppUrl()} target="_blank" className="flex-1">
              <Button
                size="lg"
                variant="outline"
                className="w-full border-primary text-primary hover:bg-primary/10 rounded-2xl py-8 text-lg font-bold"
              >
